        ...
        <section className="fadeIn-0 mx-auto mb-20 mt-10 max-w-7xl md:mt-0">
            ...
            <div className="mx-auto flex max-w-5xl flex-col-reverse gap-10 px-4 md:px-6 lg:grid lg:grid-cols-3 xl:px-0">
                    ...
                    <div className="mx-auto lg:mt-10">
                        <div className="mb-10 space-y-4 text-sm leading-6 md:text-lg md:leading-9">
                            <p>
                                ...
                                solución integral que revolucionará la
                                organización de eventos deportivos en nuestra
                                región. Con un enfoque centrado en la eficiencia
                                y la experiencia del usuario, hemos creado una
                            ...
                            <p>
                                ...
                                del Taekwondo en Neuquén. Como equipo de
                                desarrollo, nos enorgullece contribuir al
                                crecimiento de nuestra comunidad deportiva.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <PrimaryButton className="flex w-full items-center justify-center gap-2 p-5">
                        <svg
